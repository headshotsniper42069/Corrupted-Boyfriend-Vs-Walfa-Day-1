...
function onCreatePost()
    ...
    makeLuaSprite("portal", "Backgrounds/Indie/portal", -200, 550)
    addLuaSprite("portal")

    setProperty("boyfriend.x", getProperty("portal.x") + 200)
    setProperty("gf.x", getProperty("portal.x") + 150)
...
function onTimerCompleted(tag, loops, loopsLeft)
    ...
    elseif tag == "girlfriendAway" then
        doTweenX("gfFlingAwayX", "gf", getProperty("portal.x") + 150, 0.5, "quintIn")
        doTweenAngle("gfFlingAwayAngle", "gf", 330, 0.5, "quintIn")
