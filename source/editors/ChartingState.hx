...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Shameimaru Camera', "Makes a camera appear at the screen at a random point\nCamera goes away when clicking once with Left Click\nMade for Ayaya\nReplaces the previous note based cameras from v1"],
		['Hat Stack Appear', "Makes each hat appear on top of Remilia Escarlet, only works when playing Hat Stack\nStops adding hats after the 10th hat\nMade for Hat Stack"]
	];
