...
class FlxUINumericStepper extends FlxUIGroup implements IFlxUIWidget implements IFlxUIClickable implements IHasParams
{
	...
	public function getBackgroundSprites():Array<FlxSprite>
	{
		var arraysOfTheStuff:Array<FlxSprite> = []; // 0 = Background, 1 = Field Border
		var textField:FlxUIInputText = cast text_field;
		arraysOfTheStuff.push(textField.backgroundSprite);
		arraysOfTheStuff.push(textField.fieldBorderSprite);
		return arraysOfTheStuff;
	}
}
