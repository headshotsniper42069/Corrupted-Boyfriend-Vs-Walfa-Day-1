...
class MP4Sprite extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, width:Float = 320, height:Float = 240, autoScale:Bool = true, interrupt:Bool = true)
	{
		super(x, y);

		video = new MP4Handler(width, height, autoScale, interrupt);
		video.alpha = 0;
