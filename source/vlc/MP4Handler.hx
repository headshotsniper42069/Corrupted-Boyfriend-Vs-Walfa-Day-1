...
class MP4Handler extends VlcBitmap
{
	...
	public function new(width:Float = 320, height:Float = 240, autoScale:Bool = true, interrupt:Bool = true)
	{
	...
	{
		if ((FlxG.keys.justPressed.ENTER || FlxG.keys.justPressed.SPACE) && isPlaying && interrupt)
			finishVideo();
